        ...
        >
            <svg aria-hidden="true" focusable="false" viewBox="0 0 32 32">
                ...
                <g class="ink-octopus__cross" fill="#ed4a2b">
                    <path d="M2.6 2.8C3.8 1.6 5.5 2.3 6.9 4L13.8 11.8C15 13.1 15.9 13.9 17.2 15L35.8 29.5C37.5 30.8 36.7 33.5 34.6 33.8C33.7 33.9 33 33.2 32.2 32.6L13.9 18.2C12.4 17 11.5 15.6 10.3 14.3L2.5 6.5C1.3 5.3 1.4 4 2.6 2.8Z"/>
